    ...
    <div class="conteudo-pagina">
        ...
        <div class="informacao-pagina">
            ...
            <div style="width: 30%; margin-right: auto; margin-left: auto;">
                ...
                {{-- recebos um variavel produto que é um objeto e uma variavel unidade 
                que é uma colletion , array de ojetos do controller produto --}}
                <form method="POST" action="{{route('produto.update',['produto'=>$produto->id])}}">
                    @csrf
                    {{-- UTILIZAMOS PARA DIZER QUE FAREMOS UM REQUEST PUT --}}
                    {{-- DESSA FORMA , O LAREVEL AO RECEBER ESSA FORMULARIO DO LADO DO BACKEND 
                    ,ATRAVES DO METODO POST, VAI FAZER UM PAYLOAD ANEXADO A ESSA REQUISIÇÃO 
                    QUE PODERAR SER ACESSADA ATRAVES DO METODO PUT  --}}
                    @method('PUT')
